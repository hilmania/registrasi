function [filename, pathname, filterindex] = myuigetfile(varargin)
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % if (myusejavadialog('uigetfile'))
%     [filename, pathname, filterindex] = myuigetputfile_helper(0, varargin{:});
% else
    [filename, pathname, filterindex] = myuigetfile_deprecated(varargin{:});
% end 
